 ...
 *   <li>{@link org.malai.interaction.impl.InteractionImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InteractionImpl extends EObjectImpl implements Interaction {
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InteractionPackage.INTERACTION__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case InteractionPackage.INTERACTION__HELPERS:
				return getHelpers();
			case InteractionPackage.INTERACTION__NAME:
				return getName();
		}
