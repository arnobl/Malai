...
import org.malai.interactiveSystem.impl.InteractiveSystemPackageImpl;
...
public class InteractionPackageImpl extends EPackageImpl implements InteractionPackage {
	...
	public static InteractionPackage init() {
		...
		InteractiveSystemPackageImpl theInteractiveSystemPackage = (InteractiveSystemPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(InteractiveSystemPackage.eNS_URI) instanceof InteractiveSystemPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(InteractiveSystemPackage.eNS_URI) : InteractiveSystemPackage.eINSTANCE);
	...
	public EAttribute getInteraction_Name() {
		return (EAttribute)interactionEClass.getEStructuralFeatures().get(10);
	}
